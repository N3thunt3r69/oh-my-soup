...
from roboms.git_ops import HeadDriftError
...
from roboms.proxy_hmac import HEADER_SIGNATURE, HEADER_TIMESTAMP, sign, verify
...
async def test_round_trip_all_endpoints(round_trip_app) -> None:
    ...
    assert await client.get_authenticated_login() == "roboms-bot"
    ...
    assert existing_pr.author == "roboms-bot"
