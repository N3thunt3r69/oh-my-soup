"""Client half of the robooms ↔ gh-proxy channel.
...
routing clone/fetch/push through the proxy too — robooms never holds the PAT.
...
from roboms.git_ops import GitCommandError, HeadDriftError, PushResult
...
class GitHubProxyClient:
    """HMAC-signed REST client speaking to a `roboms.proxy.server` instance.
