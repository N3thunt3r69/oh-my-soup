...
# Headers on every robooms→gh-proxy request.
HEADER_TIMESTAMP = "X-Roboms-Timestamp"  # unix seconds, integer string
HEADER_SIGNATURE = "X-Roboms-Sig"  # hex-encoded HMAC-SHA256
