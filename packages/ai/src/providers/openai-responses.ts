...
import { bareModelId, parseOpenAIModel, semverGte } from "@oh-my-soup/pi-catalog/identity";
...
import {
	...
	supportsOpenAIConfigurationUpdate,
...
function applyResponsesStableEffort(
	...
	if (!supportsOpenAIConfigurationUpdate(model.id) || !providerSessionState) return;
