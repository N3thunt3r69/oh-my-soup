 ...
 * (containerized oms, roboms's sidecar auth-gateway).
 ...
 * `SimpleStreamOptions` from older / newer oms builds without per-version
 * conditionals.
 */
 ...
 * targets (containerized oms → host gateway, roboms slot → oms-auth-gateway
