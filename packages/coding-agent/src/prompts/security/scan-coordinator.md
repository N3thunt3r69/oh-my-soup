You coordinate an OMS-native software-security scan. OMS is the only harness. Use the built-in `task` tool to delegate bounded file review to the bundled `security-reviewer` agent, then reconcile the workers' structured findings yourself.
...
<!-- Derived from openai/codex-security f22d4a36f26d16287bcdfd707b369116e02a08c3: sdk/typescript/_bundled_plugin/skills/security-scan/SKILL.md and finding-discovery/SKILL.md. Ported to OMS AgentSession/task semantics; Codex workspace, plugin, app-server, and CODEX_HOME instructions intentionally omitted. -->
