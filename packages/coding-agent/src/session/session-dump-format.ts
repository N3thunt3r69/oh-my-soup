...
import type { AssistantMessage, Model, ToolExample, TSchema } from "@oh-my-soup/pi-ai";
import { renderDelimitedThinking, renderToolInventory } from "@oh-my-soup/pi-ai/dialect";
