// OMS-owned pre-analysis parent watchdog.
//@category OMS
...
public class OmsGhidraWatchParent extends GhidraScript {
	private static final String PARENT_PID_ENV = "OMS_GHIDRA_PARENT_PID";
	private static final String OWNER_PROPERTY_PREFIX = "oms.ghidra.parent-watch.";
	...
	public void run() {
		...
		if (args.length != 1 || args[0].isBlank()) {
			throw new IllegalArgumentException("OmsGhidraWatchParent requires a lifecycle ID");
		}
