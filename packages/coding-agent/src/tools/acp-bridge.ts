 ...
 * updated immediately. Internal artifacts ('/Users/theo/.oms/agent/sessions/-Projects-oh-my-soup/2026-06-10T09-11-41-506Z_019eb0cd-3ec2-7000-92aa-1b82aa4d78f0/local' plan files, other scheme
 * URLs) are always written directly to disk — those are OMS-owned and should
 ...
 *
 * Returns `false` for internal-URL paths (e.g. `'/Users/theo/.oms/agent/sessions/-Projects-oh-my-soup/2026-06-10T09-11-41-506Z_019eb0cd-3ec2-7000-92aa-1b82aa4d78f0/local/PLAN.md'`) and for the
 * active plan file while plan mode is enabled — both are OMS-internal artifacts
...
export function shouldRouteWriteThroughBridge(
	...
	// OMS-owned session artifacts (plan files, scratch notes) must stay off the
