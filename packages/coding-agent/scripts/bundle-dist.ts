...
// `oms-legacy-pi-modules` exists only in compiled binaries via the build plugin;
...
// bundled).
const RUNTIME_EXTERNAL = ["puppeteer-core", "camoufox-js", "@babel/parser"];
