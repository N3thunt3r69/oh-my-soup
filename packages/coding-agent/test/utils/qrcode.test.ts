...
import { QrCode, type QrEcLevel, renderQrHalfBlocks } from "@oh-my-soup/pi-coding-agent/utils/qrcode";
...
describe("renderQrHalfBlocks", () => {
	it("frames the symbol in a light quiet zone wide enough for the margin", () => {
		const qr = QrCode.encodeText("https://github.com/pickpocket/oh-my-soup#demo", "M");
		const margin = 3;
