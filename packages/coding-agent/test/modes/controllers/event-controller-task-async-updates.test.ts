...
import type { ToolExecutionComponent } from "@oh-my-soup/pi-coding-agent/modes/components/tool-execution";
...
import type { TaskToolDetails } from "@oh-my-soup/pi-coding-agent/task/types";
import type { BashToolDetails } from "@oh-my-soup/pi-coding-agent/tools/bash";
