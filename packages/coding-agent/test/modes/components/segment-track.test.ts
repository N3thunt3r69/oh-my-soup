...
import {
	...
	type TrackSegment,
} from "@oh-my-soup/pi-coding-agent/modes/components/segment-track";
import { initTheme, type ThemeColor, theme } from "@oh-my-soup/pi-coding-agent/modes/theme/theme";
