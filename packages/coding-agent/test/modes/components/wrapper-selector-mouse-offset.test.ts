...
import { PluginSelectorComponent } from "@oh-my-soup/pi-coding-agent/modes/components/plugin-selector";
import { QueueModeSelectorComponent } from "@oh-my-soup/pi-coding-agent/modes/components/queue-mode-selector";
import { ThemeSelectorComponent } from "@oh-my-soup/pi-coding-agent/modes/components/theme-selector";
import { ThinkingSelectorComponent } from "@oh-my-soup/pi-coding-agent/modes/components/thinking-selector";
