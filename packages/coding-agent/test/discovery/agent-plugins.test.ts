...
import {
	...
	parseAgentPluginMcp,
} from "@oh-my-soup/pi-coding-agent/discovery/agent-plugin-format";
import {
	clearClaudePluginRootsCache,
	injectPluginDirRoots,
	listClaudePluginRoots,
} from "@oh-my-soup/pi-coding-agent/discovery/helpers";
import { getPluginsDir, removeWithRetries } from "@oh-my-soup/pi-utils";
import "@oh-my-soup/pi-coding-agent/discovery/agent-plugins";
