...
import { runStartupSplash } from "@oh-my-soup/pi-coding-agent/modes/setup-wizard/startup-splash";
import { initTheme } from "@oh-my-soup/pi-coding-agent/modes/theme/theme";
import type { InteractiveModeContext } from "@oh-my-soup/pi-coding-agent/modes/types";
import { shouldShowStartupSplash } from "@oh-my-soup/pi-coding-agent/startup-splash";
