 ...
 * brush spawn). This test pulls the fix end-to-end through the OMS coding
 * agent stack:
 *
 *   AgentSession.prompt
 *     → Agent.prompt (real)
 ...
 * SIGTTIN/SIGTTOU the OMS host process.
 */
...
import { BashTool, type ToolSession } from "@oh-my-soup/pi-coding-agent/tools";
