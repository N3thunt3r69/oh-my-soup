...
import type { Context, ImageContent, Message, TextContent, ToolResultMessage } from "@oh-my-soup/pi-ai";
...
} from "@oh-my-soup/pi-coding-agent/session/snapcompact-inline";
