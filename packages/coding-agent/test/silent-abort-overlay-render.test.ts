...
import type { ObservableSession } from "@oh-my-soup/pi-coding-agent/modes/session-observer-registry";
...
function makeSubagentRegistry(sessions: ObservableSession[]) {
	...
	} as unknown as import("@oh-my-soup/pi-coding-agent/modes/session-observer-registry").SessionObserverRegistry;
}
