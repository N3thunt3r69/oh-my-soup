...
import { SignInTab } from "@oh-my-soup/pi-coding-agent/modes/setup-wizard/scenes/sign-in";
import type { SetupSceneHost } from "@oh-my-soup/pi-coding-agent/modes/setup-wizard/scenes/types";
