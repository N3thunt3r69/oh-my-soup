...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@oh-my-soup/pi-coding-agent/capability/rule";
import { bucketRules } from "@oh-my-soup/pi-coding-agent/capability/rule-buckets";
