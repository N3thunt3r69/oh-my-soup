...
import { EDIT_MODE_STRATEGIES } from "@oh-my-soup/pi-coding-agent/edit/streaming";
...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule, ruleCapability } from "@oh-my-soup/pi-coding-agent/capability/rule";
