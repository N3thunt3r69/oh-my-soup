...
import { SttClient } from "@oh-my-soup/pi-coding-agent/stt/asr-client";
import type { SttWorkerInbound, SttWorkerOutbound } from "@oh-my-soup/pi-coding-agent/stt/asr-protocol";
