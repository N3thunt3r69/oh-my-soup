...
import {
	...
	parseDefaultBranch,
	parseGitHubRepo,
} from "@oh-my-soup/pi-coding-agent/modes/components/status-line/git-utils";

describe("parseGitHubRepo", () => {
	test("parses HTTPS URL", () => {
		expect(parseGitHubRepo("https://github.com/pickpocket/oh-my-soup.git")).toBe("pickpocket/oh-my-soup");
	});

	test("parses HTTPS URL without .git suffix", () => {
		expect(parseGitHubRepo("https://github.com/pickpocket/oh-my-soup")).toBe("pickpocket/oh-my-soup");
	});

	test("parses SSH scp-style URL", () => {
		expect(parseGitHubRepo("git@github.com:loftiskg/oh-my-soup.git")).toBe("loftiskg/oh-my-soup");
	});

	test("parses SSH scp-style URL without .git suffix", () => {
		expect(parseGitHubRepo("git@github.com:loftiskg/oh-my-soup")).toBe("loftiskg/oh-my-soup");
	});
