...
import { StatusLineComponent, type StatusLineSettings } from "@oh-my-soup/pi-coding-agent/modes/components/status-line";
import { STATUS_LINE_PRESETS } from "@oh-my-soup/pi-coding-agent/modes/components/status-line/presets";
