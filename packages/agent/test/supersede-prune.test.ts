...
import type { SessionEntry, SessionMessageEntry } from "@oh-my-soup/pi-agent-core/compaction";
import {
...
import type { AssistantMessage, TextContent, ToolResultMessage } from "@oh-my-soup/pi-ai";
