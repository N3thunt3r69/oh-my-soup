...
Model catalog for [oh-my-soup](https://github.com/pickpocket/oh-my-soup): bundled model database, provider discovery, model identity, classification, and equivalence.
