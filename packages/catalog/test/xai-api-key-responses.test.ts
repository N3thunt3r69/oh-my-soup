...
import { CATALOG_PROVIDERS } from "@oh-my-soup/pi-catalog/provider-models/descriptors";
...
const XAI_SPEC_BASE = {
	...
	maxTokens: 500_000,
} satisfies Omit<ModelSpec<"openai-responses">, "api">;
...
describe("paid xAI Responses discovery contract", () => {
	it("registers xai on the Responses discovery path", () => {
	...
	it("drops stale Chat Completions cache rows before offline Responses reuse", async () => {
