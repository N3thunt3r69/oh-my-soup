...
import { sakanaModelManagerOptions } from "@oh-my-soup/pi-catalog/provider-models/openai-compat";
import type { FetchImpl, ModelSpec, ResolvedOpenAIResponsesCompat } from "@oh-my-soup/pi-catalog/types";
